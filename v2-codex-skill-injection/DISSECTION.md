...
## 八、素材来源确认(2026-09-15 补)

**素材文件已落盘**: `dossier/transcript.md`(材料4_结构化整理.md 链接 2, 23 段转写 + 7 帧 OCR)+ `dossier/transcript_extra.md`(链接 3, 音轨无效但相关)。

**与工具一致性**: 视频七步(装/激活/自读/能力声明/下指令/执行/免责)与 v2 十二段链一一对应; 激活词「冷咖啡」/自读探针/能力声明槽位全对上。**v2 = 真复现**(唯一素材证据完整的视频)。
