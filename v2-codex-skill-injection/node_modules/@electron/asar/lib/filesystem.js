...
export class Filesystem {
    ...
    insertFile(p, streamGenerator, shouldUnpack, file, options = {}) {
        ...
        return getFileIntegrity(streamGenerator()).then((integrity) => this.storeFileEntry(node, size, executable, integrity));
    }
    /**
     ...
     */
    storeFileEntry(node, size, executable, integrity) {
